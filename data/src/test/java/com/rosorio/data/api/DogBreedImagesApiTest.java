 ...
 */
public class DogBreedImagesApiTest {
    private DogBreedImagesApi api;
    ...
    public void setUp() throws Exception {
        ...
        api = new Retrofit.Builder().baseUrl(url)
                ...
                .client(client)
                .build().create(DogBreedImagesApi.class);
    ...
    @Test
    public void getBreedImages_shouldReturnBreedImagesResponse_whenSuccess() throws Exception {
        ...
        BreedImagesResponse response = api.getBreedImages("name").blockingFirst();
